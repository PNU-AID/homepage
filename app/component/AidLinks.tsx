...
export default function AidLinks() {
  ...
  return (
    <section id="aid_links" className="flex items-center justify-center gap-20 font-black text-xl md:gap-2 md:flex-col">
      <Link className="flex flex-col items-center p-8 border-2 border-gray-300 md:w-full md:p-4"
        target="_blank"
        href={aidUrl.github}
      >
