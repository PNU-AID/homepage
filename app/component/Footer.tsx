    ...
    <footer className="flex m-auto top-0 w-4/5 py-3 flex-col items-between space-y-5 md:mt-16">
      <div className="flex justify-between md:flex-col">
        ...
        <div className="flex-col text-sm">
          ...
          <h3>
            {lang == "ko" ? "회장 강준우" : "Chairman - Junwoo Kang"}{" "}
            (jangtai4@pusan.ac.kr)
          </h3>
          <h3>
            {lang == "ko" ? "부회장 손봉국" : "Vice Chairman - Son Bong-guk"}{" "}
      ...
      <div className="flex flex-col items-center">
        <p className="font-bold md:text-xs md:whitespace-nowrap">
          AID <text className="md:hidden">(AI Developers)</text> in PNU © 2022
          ALL RIGHTS RESERVED
        </p>
