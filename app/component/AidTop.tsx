    ...
    <section className="" id="about_us">
      <div className="gap-y-2 flex flex-col md:justify-center">
        ...
        {lang == "ko" ? (
          ...
          <p className="text-sm text-gray-500">
            AID is a club where people interested in AI development conduct
            studies and seminars together, and develop through competitions and
            projects. We aim to expand our network with people who dream of the
            same career path and develop individual and group skills. <br />
            <br />
            Under the guidance of Professor Cho Joon-soo of the AI club at Pusan
            National University, it was established in the first semester of
            2022 with students from Pusan National University's Computer Science
            and Engineering, and various students are working together.
          </p>
        )}
        {
          ...
          new Date() <= new Date(recruitDate.end) ? (
            <div className="flex items-center gap-3 md:flex-col-reverse w-full md:mt-8">
              ...
              <p className="md:text-sm md:text-start w-full text-nowrap">
                {lang == "ko" ? "모집기간" : "Recruitment Period"} -{" "}
                {dateConverter(recruitDate.start)}~
